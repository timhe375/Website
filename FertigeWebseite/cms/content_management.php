...
<?php
	...
	echo '<form id="formular" action="eingabe_cms.php" , method="post">';
	echo '<br />';
	echo '<label for="bereich">Bereich:</label>';
	echo '<br />';
	echo '<select id="bereich" name="bereich">';
		echo '<option value="xx">Bitte ausw&auml;hlen</option>';
        echo '<option value="home_text">Starteseiten Textbearbeitung</option>';
        echo '<option value="erwachsene_text">Erwachsene Textbearbeitung</option>';
        echo '<option value="kinder_text">Kinder Textbearbeitung</option>';
	echo '</select>';
    ...
    echo '<br /><br />';
	echo '<form id="formular" action="../admin.php" , method="post">';
