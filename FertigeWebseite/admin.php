...
<?php
    ...
    {
        $link = mysqli_connect ("localhost", "root", "", "datenbank");
    ...
    if (@$_SESSION ['eingeloggt'])
    {
		...
		echo '<br />';
        echo '<form action="cms/content_management.php", method="post">';
        echo '<input type="submit" value="Seiteninhalt bearbeiten" />';
        echo '</form>';

		//echo '<form action="../cms/kontakt_ausgabe.php", method="post">';
        //echo '<input type="submit" value="Kontakt Daten" />';
        //echo '</form>';

		//echo '<form action="../cms/gaestebuch_ausgabe.php", method="post">';
        //echo '<input type="submit" value="G&auml;stebuch Daten" />';
        //echo '</form>';
		...
		echo '<br />';
		echo '<form id="formular" action="index.php" , method="post">';
